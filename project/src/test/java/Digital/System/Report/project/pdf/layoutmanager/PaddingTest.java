package Digital.System.Report.project.pdf.layoutmanager;
...
public class PaddingTest {
    ...
    @Test public void equalHashTest() {
        ...
        equalsDistinctHashCode(Padding.of(1), Padding.of(1,1,1,1), Padding.of(1), Padding.of(2,1,1,1));

        // Test transposed middle items are different (but have same hashcode)
        equalsSameHashCode(Padding.of(3, 5, 7, 1.1), Padding.of(3, 5, 7, 1.1), Padding.of(3, 5, 7, 1.1),
        ...
        equalsSameHashCode(Padding.of(1), Padding.of(1, 1, 1, 1), Padding.of(1), Padding.of(1, 1, 1, 1.0001));
    }
